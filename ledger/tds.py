...
from .helper import _safe, parse_indian_date
...
class TDSEngine:
    ...
    def detect_section(
        ...
        for keyword, section_code in self._KEYWORD_SECTION_MAP:
            if keyword in text:
                return section_code
    ...
    def _compute_rate(
        ...
        if pan_missing and base_rate < self._SECTION_206AA_RATE:
            return self._SECTION_206AA_RATE, True
    ...
    def mark_deposited(
        ...
        for tds_e in self._entries:
            if tds_e.entry_id == entry_id:
                ...
                print("TDS entry %s marked as deposited on %s.", entry_id, deposit_date)
                return True

        print("mark_deposited: entry_id '%s' not found in register.", entry_id)
        return False
    ...
    def build_form_26q(
        ...
        for e in register.entries:
            ...
            lines.append(Form26QLine(
                ...
                deductee_type_code  = self._DEDUCTEE_TYPE_CODES[e.deductee_type],
    ...
    def pending_deposits(self, as_on: Optional[date] = None) -> List[dict]:
        ...
        for e in self._entries:
            ...
            due = self._tds_due_date(
                deduction_date=e.date, 
                section=TDS_SECTIONS.get(e.section_code)
            )
