...
def reconcile(
    ...
    ai_pipeline_output = ai_matcher_pipeline(ai_input_payload, _AMOUNT_TOL=_AMOUNT_TOL)
    ai_result = ai_pipeline_output["FINAL_RESULT"]

    combined_ai_matches = ai_result.get("AI_MATCHES", []) + ai_result.get("AI_MANY_MATCHES", [])
