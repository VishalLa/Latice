...
class GSTR1Builder:
    ...
    def _build_b2c_large(self) -> list[dict]:
        """
    ...
    def _build_nil_rated(self) -> dict:
        """
    ...
    def build(
        ...
        """
        Build GSTR-1 data from the bills this instance was constructed with.
        ...
        b2b = self._build_b2b(warnings)
        b2c_large = self._build_b2c_large()
        nil_rated = self._build_nil_rated()
        hsn = self._build_hsn_summary(warnings)
